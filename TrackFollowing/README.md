...
O robô foi construído com êxito e participando da competição, ficando na sexta posição de um total onze competidores. A dificuldade encontrada no projeto foi na regulagem do sensor em relação a pista, que apresentava ondulações, ocasionando erros de leitura.

Segue imagens do robô concluiído.
